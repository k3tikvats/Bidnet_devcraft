...
from dataloader import RTBDataset
...
parser.add_argument('--weight_fac',type=float,default=1,help='weight factor of q loss')
...
BCE_criteron=nn.BCEWithLogitsLoss(pos_weight=torch.tensor([1000]))
...
train_dataset=RTBDataset('../Adobe Devcraft Dataset/dataset/train/train06.txt','../Adobe Devcraft Dataset/dataset/clk.06.txt','../Adobe Devcraft PS/city.txt','../Adobe Devcraft PS/city.txt')
test_dataset=RTBDataset('../Adobe Devcraft Dataset/dataset/val/val06.txt','../Adobe Devcraft Dataset/dataset/clk.06.txt','../Adobe Devcraft PS/city.txt','../Adobe Devcraft PS/city.txt')
